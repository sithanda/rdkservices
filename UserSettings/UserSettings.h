     ...
     private:
                             ...
                             public Exchange::IUserSettings::INotification
        {
            ...
            explicit Notification(UserSettings* parent)
                ...
                void OnAudioDescriptionChanged(bool enabled) override
                {
                ...
                void OnLocaleChanged(const string &locale) override
                {
                    LOGINFO("LocaleChanged: %s\n", locale.c_str());
                    Exchange::JUserSettings::Event::OnLocaleChanged(_parent, locale);
                }
                ...
                void OnPreferredClosedCaptionServiceChanged(const std::string &service) override
                {
