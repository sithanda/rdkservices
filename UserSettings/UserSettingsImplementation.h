...
namespace Plugin {
    ...
    public:
        enum Event {
                ...
                PREFERED_AUDIO_CHANGED,
                LOCALE_CHANGED,
                CAPTIONS_CHANGED,
                PREFERED_CAPTIONS_LANGUAGE_CHANGED,
                PREFERED_CLOSED_CAPTIONS_SERVICE_CHANGED
            };
    ...
    public:
        ...
        uint32_t SetLocale(const string &locale) override;
        uint32_t GetLocale(string &locale) const override;
        ...
        uint32_t SetPreferredClosedCaptionService(const std::string &service) override;
        uint32_t GetPreferredClosedCaptionService(std::string &service /* @out */) const override;
    ...
    private:
        ...
        Exchange::IStore2* m_remoteObject;
        std::list<Exchange::IUserSettings::INotification*> m_notification;
	 Core::Sink<Store2Notification> m_store_notification;
	 bool m_registeredEventHandlers;
